...
function ApplicantHomePage() {
  ...
  useEffect(() => {
    if (
      location.pathname === "/applicant-find-jobs" ||
  ...
  return (
    <div class="dashboard show">
      ...
      {activeRoute === "findjobs" && (
        <ApplicantFindJobs setSelectedJobId={setSelectedJobId} />
      )}
      {activeRoute === "myjobs" && (
        <MyJobs setSelectedJobId={setSelectedJobId} />
      )}
      ...
      {activeRoute === "viewjob" && (
        <ApplicantViewJob selectedJobId={selectedJobId} />
      )}
      {activeRoute === "appliedjobs" && (
        <ApplicantAppliedJobs setSelectedJobId={setSelectedJobId} />
      )}
      {activeRoute === "savedjobs" && (
        <ApplicantSavedJobs setSelectedJobId={setSelectedJobId} />
      )}
      {activeRoute === "interviewstatus" && (

...
const ApplicantDashboard = () => {
  ...
  const [imageSrc, setImageSrc] = useState(
    "../images/user/avatar/image-01.jpg",
  );
  ...
  const earnedBadges = badgeLevels.filter(
    (level) => cappedScore >= level.score,
  );
  ...
  const fetchDashboardScore = async (id) => {
    ...
    try {
      ...
      if (scoreRes && typeof scoreRes === "object") {
        parsedScore =
          scoreRes.total_score ?? scoreRes.totalScore ?? scoreRes.score ?? 0;
        ...
        if (Array.isArray(scoreRes.badgeScores)) {
          scoreRes.badgeScores.forEach((bs) => {
            ...
            switch (bs.badge?.toUpperCase()) {
              case "BRONZE":
                setBronzeScore(points);
                break;
              case "SILVER":
                setSilverScore(points);
                break;
              case "GOLD":
                setGoldScore(points);
                break;
      ...
      const currentGold =
        scoreRes.badgeScores?.find((b) => b.badge?.toUpperCase() === "GOLD")
          ?.points || goldScore;
    ...
    const fetchUserData = async () => {
      try {
        ...
        const newData = {
          ...
          firstName:
            response.data.basicDetails != null &&
            response.data.basicDetails.firstName != null
              ? response.data.basicDetails.firstName
              : "",
          lastName:
            response.data.basicDetails != null &&
            response.data.basicDetails.lastName != null
              ? response.data.basicDetails.lastName
              : "",
        };
                      ...
                      <>
                        ...
                        <div style={{ position: "relative" }}>
                          <div className="badge-bar">
                            <div
                              className="segment bronze"
                              style={{ width: `${bronzeWidth}%` }}
                            >
                              <span>Bronze</span>
                            </div>

                            <div
                              className="segment silver"
                              style={{ width: `${silverWidth}%` }}
                            >
                              <span>Silver</span>
                            </div>

                            <div
                              className="segment gold"
                          ...
                          >
                            {cappedScore} /{" "}
                            {nextBadge ? nextBadge.score : goldScore}
                          </div>
                        </div>
                        {!nextBadge && (
                          <p className="congrats-text">
                            {" "}
                            Congrats Buddy! You unlocked all badges!
                          </p>
                        )}
                      </>
                    )}
            ...
            <div className="col-lg-12 col-md-12">
              <div className="row dash-count profile-cards">
                <div className="profile-card-row1">
                  {/* Arena Online */}
                  {!allLoadingDone ? (
                    <div className="arena arena-skeleton">
                    ...
                    <div className="arena">
                      <div className="arena-topSection">
                        <h4 id="tour-innovation-arena">Compete. Learn. Win.</h4>
                        <p>
                          Take part in Arena’s hackathons to test your coding
                          skills and gain hands-on experience solving real
                          problems.
                        </p>
                    ...
                    {!allLoadingDone ? (
                      ...
                      <>
                        <div className="mentor-topSection">
                          <h4 id="tour-mentor-sphere">Mentor sphere</h4>
                          <span onClick={handleRedirectMentor}>View more</span>
                        </div>
                      ...
                      <div className="mentor-card-content">
                        {mentorConnectData?.items
                          ...
                          ?.map((item, idx) => {
                            ...
                            const minutes = item.startTime[1]
                              .toString()
                              .padStart(2, "0");
                            ...
                            return (
                              <div
                                ...
                                style={{
                                  ...
                                  padding: "14px 0",
                                  borderBottom:
                                    idx !== 3 ? "1px solid #f0f0f0" : "none",
                                }}
                              >
                                <div
                                  className="mentor-img-text"
                                  style={{
                                    flex: 1,
                                    display: "flex",
                                    alignItems: "center",
                  ...
                  {!allLoadingDone ? (
                    <div className="portfolio">
                      ...
                      <div className="skills-container adb-portfolio-skeleton-skills">
                        {[...Array(6)].map((_, i) => (
                          <div
                            key={i}
                            className="adb-portfolio-skeleton-pill"
                          ></div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="portfolio">
                      <div className="portfolio-heading">
                        ...
                        <span onClick={handleRedirectResume}>Explore</span>
                      </div>
                      <div className="profile-side-section">
                        <div>
                          <img
                            src={
                              imageSrc || "../images/user/avatar/image-01.jpg"
                            }
                            alt="Profile"
                            onError={() =>
                              setImageSrc("../images/user/avatar/image-01.jpg")
                    ...
                    <div className="app-card">
                      <div className="app-sub-card">
                        <p className="app-card-text">
                          Why open laptop when bitLabs can be right in your
                          pocket.
                        </p>
                      ...
                      {/* ✅ Mobile Image Below */}
                      <div className="app-img">
                        <img src={SmartPhone} alt="App Preview" />
                      </div>
                    </div>
                  )}
                      ...
                      {!allLoadingDone
                        ...
                        : techBuzzVideos.length > 0
                          ? techBuzzVideos.map((video) => (
                              <div
                                className="video-thumb-container hover-scale"
                                onClick={() =>
                                  navigate(
                                    `/applicant-verified-videos?video=${video.videoId}`,
                                  )
                                }
                              >
                                <img
                  ...
                  <div className="tech-vibes">
                    <div className="tech-vibes-header">
                      ...
                      <button
                        ...
                        onClick={handleRedirectTechVibes}
                      >
                        Explore
                      </button>
                    </div>
                          ...
                          return (
                            ...
                            >
                              <img
                                src={
                                  blog.imageUrl ||
                                  "https://via.placeholder.com/82x60?text=No+Img"
                                }
                                alt={blog.title}

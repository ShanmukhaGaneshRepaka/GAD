...
import novideosfound from "../../images/icons/no-video-found.png";
...
const VerifiedVideos = () => {
  ...
  <div className="no-videos-empty">
    <img src={nosearchresults} alt="No Videos" />
    <p>No videos found.</p>
  </div>
) :(
          <div className="oneminute-grid">
            {filteredVideos.length > 0 ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', marginTop: ''}}>
                <img src={nosearchresults} alt="No Videos" />
                <p>No videos found.</p>
              </div>
        ...
        {loading ? (
          ...
          // WHEN NO VIDEOS IN DATABASE
          <div className="no-videos-empty" style={{ height: "70%" }}>
            <img src={novideosfound} alt="No Videos" />

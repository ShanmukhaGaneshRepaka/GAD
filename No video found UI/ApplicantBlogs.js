...
import nosearchresults from "../../images/icons/no-search-results.png";
import noblogs from "../../images/icons/no-blogs.png";
...
<div className="blogs-container" style={{ width: "100%" }}>
  {loading ? (
    ...
    >
      <p style={{ fontSize: "20px", fontWeight: 600, color: "#555" }}>Loading...</p>
    </div>
  ) : filteredBlogs.length === 0 ? (
    blogs.length === 0 ? (
      ...
      >
        <img src={noblogs} width="700" height="470" style={{ marginBottom: "10px" }} />
    ...
    // backgroundColor: "#fff",
      ...
      >
        <img
          ...
          // style={{ marginBottom: "10px",maxHeight:"400px",maxWidth:"400px", minHeight:"100px",minWidth:"100px" }}
          style={{
    width: "100%",
    maxWidth: "400px",
    height: "auto",
    ...
    <>
      ...
      <div className="tv-grid">
        {filteredBlogs.map((b) => (
          <article key={b.id} className="tv-card" onClick={() => openModal(b)}>
            <div className="tv-media">
              <img src={b.imageUrl} alt={b.title} loading="lazy" />
            </div>
            <div className="tv-content">
  ...
  {hasMore && query.trim() === "" && !loading && (
    <div className="load-more-container">
      <span style={{ cursor: "pointer" }}>
        <img src={ExploreButton} alt="Load more" onClick={() => handleLoadMore()} />
      </span>
    </div>
  )}
</div>
